    ...
    this.innerHTML = /* html */ `
      <div class="contact-page">
        ...
        <div class="contact-page__content">
          <div class="contact-page__info" data-reveal>
            <h3 class="contact-page__subtitle">${t.subtitle}</h3>
            <p class="paragraph contact-page__description">${t.description}</p>
          </div>
          
          <div class="contact-page__cards" data-reveal>
            <a href="mailto:${t.email}" class="contact-card">
              <span class="contact-card__icon">✉️</span>
              <span class="contact-card__label">${t.email}</span>
            </a>
            <a href="tel:${t.phone}" class="contact-card">
              <span class="contact-card__icon">📞</span>
              <span class="contact-card__label">${t.phone}</span>
            </a>
            <a href="${t.linkedin}" target="_blank" rel="noopener noreferrer" class="contact-card">
              <span class="contact-card__icon">💼</span>
              <span class="contact-card__label">LinkedIn</span>
            </a>
            <a href="${t.github}" target="_blank" rel="noopener noreferrer" class="contact-card">
